...
import cable from "@/assets/ONESUB/cable.png";
import exam from "@/assets/ONESUB/exam.png";
import electricity from "@/assets/ONESUB/electricity.png";
import data from "@/assets/ONESUB/data.png";
...
let styleee={
  ...
  return (
    <>
          ...
          <div className="collapse navbar-collapse" id="navbarText">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item " style={{marginLeft:'620px'}}>
                <a className="text-white text-center nav-link rounded-4 p-2" href="#" style={{fontSize:'20px',width:'200px',backgroundColor:'#394968'}}>
                  Get Started
                </a>
              </li>
          ...
          <div className="row mb-5">
            <div className="col-8">
              ...
              <div className="mt-5">
                ...
                <button className="btn btn-light mt-3 rounded-pill" style={{fontSize:'19px'}}>
                  Get Started
                </button>
              </div>
            </div>
      ...
      <div className="container-fluid  " style={{backgroundColor:'#FFFFFF',marginTop:'160px'}}>
        <div className="col-11 mx-auto mt-5">
          ...
          <div className="row mt-5">
            ...
            <div className="col-3 mt-5">
              <Card title="Exam" content="" as={exam.src} w="100px" />
            </div>
            <div className="col-3 mt-5">
              <Card
                title="Cable"
      ...
      <div className="container-fluid" style={{backgroundColor:'#FFFFFF'}}>
        <div className="col-11 mx-auto">
          <div>
            <h1 className="mb-5" style={{ color: "#427df6", marginTop: "100px" }}>Data Pricing</h1>
...
<p className="fs-4">500MB-#165</p>
 ...
 <p className="fs-4">10GB #2950</p>
      ...
      <div className="container-fluid mb-5" style={{marginTop:'200px'}}>
        <div className="col-11 mx-auto">
        <div className="mb-5">
          <h1 className="mb-5" style={{color:"#427df6"}}>Features</h1>
        ...
        <div className="row">
          ...
          <div className="col-5">
            <img src={feature.src} alt="img" className="" style={{width:'100%'}} />
      ...
      <div className="container-fluid mt-5 p-3" style={styleee}>
        ...
        <div className="row mt-5 p-5">
          ...
          <div className="col-2 mt-5">
            <h1>Legal</h1>
            <p>
              <a href="" style={{textDecoration:'none',color:'black',fontSize:'20px'}}>Privacy</a>
            </p>
            <p>
              <a href="" style={{textDecoration:'none',color:'black',fontSize:'20px'}}>Terms</a>
            </p>
            <p>
              <a href="" style={{textDecoration:'none',color:'black',fontSize:'20px'}}>Cookie Policy</a>
            </p>
          </div>
          <div className="col-5 mt-5">
            <h1>Contact</h1>
            <p><a style={{textDecoration:'none',color:'black',fontSize:'20px'}}>WhatSapp: <span style={{fontSize:'20px'}} >+2348168837642</span></a></p>
            <p>
            <a style={{textDecoration:'none',color:'black',fontSize:'20px'}}>Phone Number: <span style={{fontSize:'20px'}} >08168837642</span></a>
            </p>
            <p><a style={{textDecoration:'none',color:'black',fontSize:'20px'}}>Email : <span style={{fontSize:'20px'}}>oyindamola@gmail.com</span></a></p>
          </div>
